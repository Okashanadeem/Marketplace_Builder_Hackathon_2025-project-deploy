...
export default function ItemsPage() {
  ...
  useEffect(() => {
    ...
    return () => {
      setLoading(false); // Cleanup loading state on component unmount
    };
  }, []);
  ...
  return (
    <>
      <Head>
        <title>Our Latest Products | My E-commerce Store</title>
        <meta name="description" content="Browse our latest collection of products at My E-commerce Store." />
      </Head>
