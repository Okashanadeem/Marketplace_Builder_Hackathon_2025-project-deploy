      ...
      <div className="bg-[#FBEBB5] text-black">
        ...
        <div className="flex flex-col items-center text-center px-6 py-16 bg-[#FAF4F4]">
          ...
          <p className="mt-4 text-lg md:text-xl text-gray-700 max-w-2xl">
            Crafting furniture with a perfect blend of elegance and durability.
            Discover the artistry behind every piece we create.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-12 bg-white gap-8">
          <div className="md:w-1/2">
            ...
            <p className="mt-4 text-gray-600 leading-relaxed">
              Established with a passion for timeless design and craftsmanship,
              we’ve been delivering premium-quality furniture for over a decade.
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="flex flex-col items-center text-center bg-[#FAF4F4] p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mt-2">
                Our designs bring elegance and luxury into your living spaces,
            ...
            <div className="flex flex-col items-center text-center bg-[#FAF4F4] p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mt-2">
                Every piece is crafted with precision and undergoes rigorous quality
                checks for unmatched durability.
              </p>
            </div>
        ...
        <div className="flex flex-col items-center justify-center text-center bg-[#FFF9E5] px-6 py-12">
          ...
          <a
            href="/shop"
            className="mt-6 px-6 py-3 bg-black text-white rounded-full shadow-md inline-block"
          >
